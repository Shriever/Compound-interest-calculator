  ...
  return (
    <div>
      ...
      <p className='about-text'>
        ...
        calculate compound interest. I felt comfortable with primitive
        types thanks to my experience with the C programming language which I
        worked with in Harvard's CS50 course. But defining types for functions
        and React Hooks definitely took some getting used to.
      </p>
      <br />
      <h2>Tech Used</h2>
